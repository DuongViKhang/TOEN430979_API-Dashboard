...
class EnterEmailTestSelenium:
    ...
    def enterEmail(self, email):
        ...
        if self.driver.current_url != 'http://localhost:50001/auth/reset-password':
...
def test_case1(enterEmail_fixture):
    ...
    case = {'email': 'KhAnG1379@gmail.com', 'screenshot_name': 'testcase1'}
